...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            f"pytest {_TEST_PATH} -k 'fabric2d-mesh-2x4-2link and layer3 and gate_device and no_ref and isl_1k28'",
        ...
        pytest.param(
            f"pytest {_TEST_PATH} -k 'torus-xy-8x4 and layer0 and gate_device and no_ref and isl_5k'",
        ...
        pytest.param(
            f"pytest {_TEST_PATH} -k 'torus-xy-8x4 and layer3 and gate_device and no_ref and isl_5k'",
        ...
        pytest.param(
            f"pytest {_TEST_PATH} -k 'torus-y-4x4 and layer0 and gate_device and no_ref and isl_2k56'",
            17_978_418,
            "deepseek_v3_prefill_block",
        ...
        pytest.param(
            f"pytest {_TEST_PATH} -k 'torus-x-4x4 and layer3 and gate_device and no_ref and isl_2k56'",
            54_804_819,
            "deepseek_v3_prefill_block",
        ...
        pytest.param(
            f"pytest {_TEST_PATH} -k 'torus-xy-4x4 and layer3 and gate_device and no_ref and isl_2k56'",
            52_978_544,
            "deepseek_v3_prefill_block",
